...
//                     onClick={() => handleAddToCart(item)}
//                     className={`py-2 px-4 rounded flex-grow transition-colors duration-200 ${
//                       item.inventory.inStock
//                         ? "bg-green-500 hover:bg-green-600 text-white"
//                         : "bg-gray-500 text-gray-300 cursor-not-allowed"
//                     }`}
//                   >
//                     {item.inventory.inStock ? "Add To Cart" : "Out of Stock"}
//                   </button>
//                 </div>
//               </div>
//             </div>
...
const ProductsPage: React.FC = () => {
  ...
  const handleAddToCart = (product: Product) => {
    ...
    if (currentQuantity < product.inventory.quantity) {
      ...
      // Show toast when quantity exceeds stock
